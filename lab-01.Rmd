...
class(visitors$n_2021)
class(visitors$attraction)
class(visitors$admission)
class(visitors$setting)
class(visitors$region)
...
#answer: "The Crown Estate, Windsor Great Park", n = 5,636,844
```
...
#answer: "Knowsley Safari and Knowsley Hall"
```
...
**not available: some of the data in n_2021 is also NA so any calculations will return NA**
...
**data is not spread evenly & larger values are more extreme**
